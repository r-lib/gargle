...
[`gargle::AuthState`](https://gargle.r-lib.org/dev/reference/AuthState-class.md)
...
[`gargle::gargle_oauth_email()`](https://gargle.r-lib.org/dev/reference/gargle_options.md).
...
Read the help for
[`gargle::gargle_oauth_cache()`](https://gargle.r-lib.org/dev/reference/gargle_options.md)
and
...
[`gargle::request_develop()`](https://gargle.r-lib.org/dev/reference/request_develop.md)
and
[`gargle::request_build()`](https://gargle.r-lib.org/dev/reference/request_develop.md)
...
The
[`vignette("get-api-credentials")`](https://gargle.r-lib.org/dev/articles/get-api-credentials.md)
