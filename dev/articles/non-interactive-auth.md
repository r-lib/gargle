...
[`gargle::credentials_gce()`](https://gargle.r-lib.org/dev/reference/credentials_gce.md)
...
[`gargle::with_cred_funs()`](https://gargle.r-lib.org/dev/reference/cred_funs.md)
or
[`gargle::local_cred_funs()`](https://gargle.r-lib.org/dev/reference/cred_funs.md).
