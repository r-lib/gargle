...
2.  Use
    [`gargle::gargle_oauth_client()`](https://gargle.r-lib.org/dev/reference/gargle_oauth_client_from_json.md).
...
- Do *Create key* and download as JSON. This file is what we mean when
  ...
  [`gargle::credentials_service_account()`](https://gargle.r-lib.org/dev/reference/credentials_service_account.md)
