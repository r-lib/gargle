...
This outlines how to propose a change to gargle. For more detailed info
...
- We recommend that you create a Git branch for each pull request
  (PR).  
- Look at the status of the `R-CMD-check` GitHub Actions workflows
...
Please note that the gargle project is released with a [Contributor Code
of Conduct](https://gargle.r-lib.org/dev/CODE_OF_CONDUCT.md). By
