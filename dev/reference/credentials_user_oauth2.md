...
token](https://gargle.r-lib.org/dev/reference/credentials_service_account.md)
or [workload identity
federation](https://gargle.r-lib.org/dev/reference/credentials_external_account.md).
...
A [Gargle2.0](https://gargle.r-lib.org/dev/reference/Gargle-class.md)
token.
