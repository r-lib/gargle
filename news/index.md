...
- [`gargle_last_response()`](https://gargle.r-lib.org/reference/gargle_last_response.md)
  and
  [`gargle_last_content()`](https://gargle.r-lib.org/reference/gargle_last_response.md)
  are newly exported.
...
- The transition from OAuth “app” to OAuth “client” is fully enacted
  ...
  A new
  [`vignette("oauth-client-not-app")`](https://gargle.r-lib.org/articles/oauth-client-not-app.md)
...
- [`check_is_service_account()`](https://gargle.r-lib.org/reference/check_is_service_account.md)
...
[`gargle_app()`](https://gargle.r-lib.org/reference/oauth_app_from_json.md).
...
by [`token_fetch()`](https://gargle.r-lib.org/reference/token_fetch.md),
...
- [`field_mask()`](https://gargle.r-lib.org/reference/field_mask.md) is
  a utility function for constructing a Protocol-Buffers-style,
...
- All built-in API credentials have been rotated and are stored
  ...
  [Privacy policy](https://tidyverse.org/google_privacy_policy/) as well
  as a [policy for authors of packages or other
  applications](https://tidyverse.org/google_privacy_policy/#policies-for-authors-of-packages-or-other-applications).
