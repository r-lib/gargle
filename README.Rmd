...
Here's an example of using request and response helpers to make a one-off request to the [Poly API](https://developers.google.com/poly/) and get info about a single asset. We then display its thumbnail PNG.
