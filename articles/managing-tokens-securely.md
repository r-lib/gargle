...
key <- secret_make_key()
key
#> [1] "Uvhiccimky26vmG-biAcdg"
```

[`gargle::secret_make_key()`](https://gargle.r-lib.org/reference/gargle_secret.md)
is a copy of
...
user-level `.Renviron` file:
    ...
    SOMETHING_KEY=Uvhiccimky26vmG-biAcdg
...
[`gargle::secret_write_rds()`](https://gargle.r-lib.org/reference/gargle_secret.md)
is a copy of
...
[`gargle::secret_read_rds()`](https://gargle.r-lib.org/reference/gargle_secret.md)
