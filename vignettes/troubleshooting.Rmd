...
Many users of packages like googlesheets4 or googledrive tacitly rely on the built-in OAuth app provided by those packages (provided by gargle, actually).
The package maintainers and OAuth app owners will need to periodically create a new OAuth app and disable the old one.
...
**Restart R!**
Resume your work and chances are you'll be prompted to re-auth with the new app
...
As of gargle version v1.1.0, we're trying harder to recognize this specific problem and to provide a more detailed and actionalbe error message:
