...
It defaults to `TRUE`, i.e. gargle defaults to being very quiet. This is because gargle is designed to try a bunch of auth methods (many of which will fail) and persist doggedly until one succeeds. If none succeeds, gargle tried to guide the user through auth or, in a non-interactive session, it throws an error.
