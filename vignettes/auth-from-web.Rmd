...
If you are working with R in a web-based context, like [RStudio Server](https://rstudio.com/products/rstudio/download-server/) or [Cloud](https://rstudio.cloud), your experience of browser-based auth flows will be
...
If you're creating content to be deployed (for example on [shinyapps.io](https://www.shinyapps.io) or [RStudio Connect](https://rstudio.com/products/connect/)), you will also need to consider how the [deployed content will authenticate non-interactively](https://gargle.r-lib.org/articles/non-interactive-auth.html). 
