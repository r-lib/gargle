...
(If your package already has an `.onLoad` function defined, add the `.auth <<- gargle::init_AuthState(...)` to that one instead of creating a new one.)
