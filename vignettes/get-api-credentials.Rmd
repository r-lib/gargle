...
Assuming you already have a GCP project and the API(s) of interest are enabled, do this:

  * [Setting up API keys](https://support.google.com/googleapi/answer/6158862)
  
Package maintainers might want to build this API key in as a fallback, possibly taking some measures to obfuscate the key and limit its use to your package.
