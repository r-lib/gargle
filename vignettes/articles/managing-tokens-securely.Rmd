...
This writes an encrypted version of `gargle-testing.json` to `inst/secret/gargle-testing.json` in the current working directory, which is presumably the top-level directory of gargle's source. This encrypted file *should* be committed and pushed.
