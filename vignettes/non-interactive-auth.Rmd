...
Here we discuss how gargle's GCE auth can work for a related service, Google Kubernetes Engine (GKE), using [Workload Identity](https://docs.cloud.google.com/kubernetes-engine/docs/how-to/workload-identity).
...
1. Following the [Workload Identity docs](https://docs.cloud.google.com/kubernetes-engine/docs/how-to/workload-identity), you create a service account as normal and give it permissions and scopes needed to, say, upload to BigQuery.
...
Documentation around `GKEStartPodOperator()` within Cloud Composer can be found [here](https://docs.cloud.google.com/composer/docs/composer-2/use-gke-operator).
